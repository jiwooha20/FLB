    ...
    def generate(
        ...
        with self.maybe_autocast():
            ...
            outputs = self.llm_model.generate(
                ...
                use_flb=use_flb if use_flb is not None else None,
                flb_gamma=flb_gamma if flb_gamma is not None else None,
                flb_lambda=flb_lambda if flb_lambda is not None else None
            )
